...
radio.openWritingPipe(pipe)#pipes[0])     # open the defined pipe for writing
radio.printDetails()      # print basic detals of radio



def send_msg(input_msg, pipe):
  radio.openWritingPipe(pipe)
  sendMessage = "BX" + input_msg

  sendMessage = list(sendMessage)  #the message to be sent
